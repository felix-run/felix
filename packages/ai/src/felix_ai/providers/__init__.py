...
from felix_ai.providers.base import ProviderSpec, placeholder_names
...
__all__ = ["ANTHROPIC", "OPENAI_COMPATIBLE", "ProviderSpec", "builtin_provider_specs", "placeholder_names"]
