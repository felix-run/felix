...
| [`WORKSPACE.md`](WORKSPACE.md) | Proposal: move the workspace tools out of the process that holds credentials, scope them per tenant and thread, and sandbox them — backends, phases, migration |
...
| [`DIAGRAMS.md`](DIAGRAMS.md) | Index of the Mermaid sources in [`diagrams/`](diagrams/), each one answering a single question about how Felix works |

Filenames in this directory are `UPPERCASE.md`; `diagrams/` holds lowercase `.mmd` sources.
